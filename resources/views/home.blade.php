            ...
            <div class="col-md-12">
                <div class="orange-border">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wrapper">
                                <p class="desp">Купить теплоизоляцию для труб или запросить подробную информацию вы можете, связавшись с нашим отделом продаж:</p>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="schedule__box">
                                            <p>Менеджер по работе с клиентами</p>
                                            <p>
                                                <a href="tel:+73912212708"> +7 (391) 221-27-08 </a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="schedule__box">
                                            ...
                                            <p>
                                                <a href="tel:+73912911313">+7 (391) 291-13-13</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
